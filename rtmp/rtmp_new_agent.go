...
func (r *RtmpNewAgent) writeMetadata(data *MediaFrame) error {
	chunk := &RtmpChunk{
		RTMP_CHANNEL_DATA,
		0,
		0,
...
func (r *RtmpNewAgent) writeFullVideo(video *MediaFrame) (err error) {
	chunk := &RtmpChunk{
		RTMP_CHANNEL_VIDEO,
		video.Timestamp,
		0,
...
func (r *RtmpNewAgent) writeFullAudio(audio *MediaFrame) (err error) {
	chunk := &RtmpChunk{
		RTMP_CHANNEL_AUDIO,
		audio.Timestamp,
		0,
...
func (r *RtmpNewAgent) writeVideo(video *MediaFrame) (err error) {
...
func (r *RtmpNewAgent) writeAudio(audio *MediaFrame) (err error) {
